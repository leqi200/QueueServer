...
public final class HttpSnoopServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // init log4j 
        Log4jInit.initLog4j();
        log=Logger.getLogger(HttpSnoopServer.class);
        ...
        try {
            ...
            log.info("Start Http Service OK...");
